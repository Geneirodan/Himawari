...
/// <summary>Callback when the presenter taps "next word": fetches the next word, answers the callback with it, and updates the cached word for the chat.</summary>
